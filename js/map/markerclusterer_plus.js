...
ClusterIcon.prototype.useStyle = function (sums) {
  ...
  this.textAlign_ = style.textAlign || "left";
  this.textDecoration_ = style.textDecoration || "none";
  this.fontWeight_ = style.fontWeight || "bold";
  this.fontStyle_ = style.fontStyle || "normal";
  this.fontFamily_ = style.fontFamily || "Arial,sans-serif";
  this.backgroundPosition_ = style.backgroundPosition || "0 0";
  this.offsetX_ = style.offsetX || 0;
  this.offsetY_ = style.offsetY || 0;
};
...
ClusterIcon.prototype.createCss = function (pos) {
  ...
  /*style.push('cursor:pointer; top:' + pos.y + 'px; left:' +
    ...
    style.push('cursor:pointer; top:' + top + 'px; left:' +
               ...
               fontWeight +'; font-style:' + this.fontStyle_ + '; text-decoration:' +
               this.textDecoration_ + ';');
...
/**
 * Returns the bounds of the cluster. You can call this from
 * a <code>click</code>, <code>mouseover</code>, or <code>mouseout</code> event handler
 * for the <code>MarkerClusterer</code> object.
 *
 * @return {google.maps.LatLng} The bounds of the cluster.
 */
...
MarkerClusterer.prototype.fitMapToMarkers = function () {
  ...
  this.getMap().fitBounds(bounds);s
};
