...
<body>
	<?php require_once '../inc-header.php'; ?>
            ...
            <section id="owl-carousel-section" style="text-align:center">
                <video controls autoplay loop preload="auto" style="width:75%;">
  <source src="http://www.villazzo.com/video/marine.mp4" type="video/mp4">
