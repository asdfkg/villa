...
<body>
	<?php require_once '../inc-header.php'; ?>
            ...
            <section id="header-section">
                <img src="/img/about/banner-booking.png">
            </section>
            <!-- Header Image Section End -->
            <section id="about-section">
                <div class="row">
                    <div class="medium-8 medium-centered columns text-center">
	                    <h4 class="text-gold">BOOK ONLINE</h4>
	                    <img src="/img/about/book-icon_computer.png">
	                    <p>Visit our <a href="/reservations/">Reservation</a> page on the website.<br /><br /></p>
						<h4 class="text-gold">BOOK BY PHONE</h4>
	                    <img src="/img/about/book-icon_phone.png">
						<p>Call us at +1 (305) 777 0146 <br />
						(from within the US also 1-877-VILLAZZO)<br /><br /></p>
						<h4 class="text-gold">BOOK BY EMAIL</h4>
	                    <img src="/img/about/book-icon_email.png">
						...
						<h4 class="text-gold">RESERVATION FORM</h4>
						...
						<h4 class="text-gold">CONFIRMATION </h4>
