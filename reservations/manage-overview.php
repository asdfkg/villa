                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #dac172; margin-bottom:50px;">
                            ...
                            do {
                                ...
                                if ($row_rs_reservationProperty['reservationStreet1'])
                                    $userInfo .= '<tr><td valign="top">Address:</td><td valign="top">' . $row_rs_reservationProperty['reservationStreet1'] . ' ' . $row_rs_reservationProperty['reservationStreet2'] . '<br />' . $row_rs_reservationProperty['reservationCity'] . ', ' . $row_rs_reservationProperty['reservationState'] . ' ' . $row_rs_reservationProperty['reservationPostcode'] . '<br />' . $row_rs_reservationProperty['reservationCountry'] . '</td></tr>';
                                $userInfo .= '</table>';
                                ...
                                <tr>
                                    ...
                                    <td valign="top"><span id="delete<?php echo $row_rs_reservationProperty['reservationId']; ?>" onclick="this.style.display = 'none';
                                            document.getElementById('deleteConfimation<?php echo $row_rs_reservationProperty['reservationId']; ?>').style.display = 'block';" class="fakeLink"><i class="fa fa-trash-o" title="Delete Reservation"></i></span><span id="deleteConfimation<?php echo $row_rs_reservationProperty['reservationId']; ?>" style="display:none;">Delete Reservation?<br /><a href="?action=delete&reservationId=<?php echo $row_rs_reservationProperty['reservationId']; ?>">yes</a> | <span onclick="document.getElementById('delete<?php echo $row_rs_reservationProperty['reservationId']; ?>').style.display = 'block';
                                                    document.getElementById('deleteConfimation<?php echo $row_rs_reservationProperty['reservationId']; ?>').style.display = 'none';" class="fakeLink">no</span></span></td>
                                    <td valign="top">
                                        <?php
                                        if ($row_rs_reservationProperty['reservationFeedbackCreateDt']) {
                                            ...
                                            <?php
                                                ...
                                                if (!$row_rs_reservationProperty['reservationFeedback']) {
